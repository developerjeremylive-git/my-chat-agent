...
const iconMap: Record<string, React.ReactNode> = {
  ...
  'light-bulb': (
    <svg xmlns="http://wwwwww.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  'trending-up': (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h9m0 0v9m0-9l-9 9-4-4-6 6" />
    </svg>
  ),
  'users': (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    ...
    >
      <div className="flex items-center mb-3">
        <div className="p-2 rounded-md bg-neutral-700 mr-3">
